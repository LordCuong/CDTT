...
namespace LeHungCuong_ASP_CDTT.Areas.Admin.Controllers
{
    public class CategoryController : Controller
    {
        ...
        public ActionResult Create(Categories category, HttpPostedFileBase image)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(Categories category, HttpPostedFileBase image)
        {
            if (ModelState.IsValid)
            {
